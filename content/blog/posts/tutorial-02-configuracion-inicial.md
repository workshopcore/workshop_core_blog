...
Una vez que conocés el panel, el siguiente paso es configurar tu espacio para que funcione según tus reglas. La sección de **Configuración** es donde definís la identidad de tu taller y, lo más importante, tu modelo de negocio.
...
Una vez que completaste todos los campos, no te olvides de hacer clic en el botón **"Guardar"** (el ícono del disquete o el botón de confirmación). Los cambios se aplican inmediatamente y son visibles para todos tus alumnos.

## Próximos Pasos

Con tu espacio ya configurado y tu modelo de precios definido, estás listo para empezar a crear las clases que tus alumnos van a reservar. En el próximo tutorial vamos a ver cómo armar tu grilla de horarios recurrente.
