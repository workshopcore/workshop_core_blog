...
- **Technical terms**: 
  ...
  - **Avoid raw URL paths**: Do not use paths like `/admin/appointments` or `/book`. Instead, use descriptive names like "Panel de Turnos Reservados" or "Página de Reservas".
